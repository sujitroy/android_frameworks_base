...
package com.android.internal.util.hydrus.weather;
...
public class WeatherClient {
    ...
    public static final String SERVICE_PACKAGE = "com.hydrus.weather.client";
    private static final String SERVICE_PACKAGE_PERMISSION = SERVICE_PACKAGE + ".READ_WEATHER";
    public static final Uri WEATHER_URI = Uri.parse("content://com.hydrus.weather.client.provider/weather");
